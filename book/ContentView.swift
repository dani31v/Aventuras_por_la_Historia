...
struct MainView: View {
    ...
    var body: some View {
            ...
            ZStack{
                ...
                (colorScheme == .dark ? Color.red : Color.pink)
                    .edgesIgnoringSafeArea(.all)
                
                NavigationView {
                    
                    if viewRouter.showhistory {
                        ZStack{
                        ...
                        ZStack{
                            ...
                            List {
                                Text("Selecciona una aventura en mundo")
                                Section("Aventuras disponibles"){
                                    HStack{
                                        Image(systemName: "checkmark.seal.fill")
                                        Text("La conquista de México")
                                    }
                                    HStack{
        ...
        // Elige el color que desees para el modo oscuro
    }
